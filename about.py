...
#         st.markdown(f'<style>{f.read()}</style>', unsafe_allow_html=True)
    ...
    table_emp =[
        ['<b>Data Scientist Intern/ITConnexion Pty Ltd/<em>2023</em></b><br>- Develop and fine-tune machine learning models for image segmentation, significantly improving accuracy and efficiency in medical image analysis.<br>- Collaborate closely with a multidisciplinary team and clients to understand healthcare domain requirements and effectively translate them into technical solutions. <br>- Design and implement prototypes to demonstrate the functionality of the machine learning model within a web application.<br>- Contribute to the creation of Entity-Relationship Diagrams (ERDs) to visualize data structure and relationships for the web application.<br>- Work closely with senior developers to integrate the machine learning model seamlessly into the web application, ensuring a user-friendly and efficient interface.',
